...
object Settings {
    ...
    object Editor {
        ...
        @Composable
        fun rememberCurrentEditor() =
            rememberPreference(key = CURRENT_EDITOR, defaultValue = "Sora")
    ...
    object Monaco {
        ...
        fun rememberMonacoTheme() =
            rememberPreference(
                key = MONACO_THEME,
                defaultValue = MonacoTheme.VisualStudioDark.value
            )
        ...
        @Composable
        fun rememberWordWrap() =
            rememberPreference(key = WORD_WRAP, defaultValue = WordWrap.On.value)
        ...
        fun rememberWrappingStrategy() =
            rememberPreference(
                key = WRAPPING_STRATEGY,
                defaultValue = WrappingStrategy.Advanced.value
            )
